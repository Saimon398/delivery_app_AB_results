...
<image src = "/images/quantity_hist.png" alt = "Гистограммы распределения количества покупок на пользователя">
...
|:--------|:---------:|:---------:|:------------:|:---------:|
|Контрольная| 364.25   |    343.70    |      0.756      |       1.135 |
|Тестовая|   352.34      |    340.40     |       0.873     |   1.825      |
