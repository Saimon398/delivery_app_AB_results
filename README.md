...
<image src = "/images/quantities_hist.png" alt = "Гистограммы распределения количества покупок на пользователя" height = 350 width = 1300>
...
<image src = "/images/revenue_hist.png" alt = "Гистограммы частот для распределения прибыли, которую приносит пользователь в контрольной и тестовой группах" height = 350 width = 1300>
...
<image src = "/images/revenue_qq_plots.png" alt = "Квантиль-квантиль графики для распределения прибыли, которую приносит пользователь в контрольной и тестовой группах" height = 350 width = 1300>
